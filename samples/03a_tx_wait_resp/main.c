 ...
 *           the DW1000 receiver to receive a response. The response could be
 ...
 *           After the response is received or if the reception timeouts, this 
 *           code just go back to the sending of a new frame.
 *
 * @copyright
 ...
 *    experimentally to be around 70 usec). Using an RX to TX delay slightly 
 *    less than this minimum turn-around time allows the application to make 
 *    the communication efficient while reducing power consumption by adjusting
 *    the time spent with the receiver activated.
 ...
 *    example.
 * 5. In this example, LDE microcode is not loaded upon calling dwt_initialise().
 ...
 * UWB microseconds (1 uus is 512/499.2 microseconds). See NOTE 2 below. 
 s*/
