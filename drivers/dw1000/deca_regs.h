...
#define RX_FQUAL_STD_NOISE_OFFSET (0)  /* byte 0..1 16 bit Standard Deviation Noise. */
...
#define RX_FQUAL_FP_AMPL2_OFFSET (2)  /* byte 2..3 16 bit First Path Amplitude point 2. */
...
#define RX_FQUAL_FP_AMPL3_OFFSET (4)  /* byte 4..5 16 bit First Path Amplitude point 3. */
...
#define RX_FQUAL_CIR_PWR_OFFSET (6)  /* byte 6..7 16 bit Channel Impulse Response Power. */
...
#define DW_GPIO_DIR_MASK           0x0011FFFFUL
...
#define GPIO_DOUT_MASK          DW_GPIO_DIR_MASK
