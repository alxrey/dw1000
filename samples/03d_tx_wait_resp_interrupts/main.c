 ...
 *           where events generated by DW1000 are handled through interrupts
 ...
 *    not conflict with someone else'ss implementation. We recommended that
 ...
 *    the communication efficient while reducing power consumption by 
 *    adjusting the time spent with the receiver activated.
 ...
 *    example.
 * 5. In this example, LDE microcode is not loaded upon calling 
...
/* Index to access the sequence number of the blink frame in the 
 * tx_msg array.
 */
...
int main(void)
{
    ...
    while (1) {
        ...
        /* Reset the TX delay and event signalling mechanism ready to await
         * the next event.
         */
        tx_delay_ms = -1;
    }
