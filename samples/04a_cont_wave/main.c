 ...
 *
 *           This example code activates continuous wave mode on channel 5 
 *           for 2 minutes before stopping operation.
 *
 * @copyright
 ...
 * 2. The user is referred to DecaRanging ARM application (distributed with 
...
int main(void)
{
    ...
    /* During initialisation and continuous wave mode activation, DW1000 clocks
     * must be set to crystal speed so SPI rate have to be lowered and will
    ...
    k_msleep(CONT_WAVE_DURATION_MS);

    /* Software reset of the DW1000 to deactivate continuous wave mode and 
